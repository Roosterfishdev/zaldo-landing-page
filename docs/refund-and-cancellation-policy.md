...
- You can cancel at any time before the trial ends to avoid any charge.
...
- From within the Zaldo dashboard (Settings → Billing), or
- Through the Stripe customer portal.

**How cancellation works:**
- Cancellation takes effect at the **end of your current billing period**. You keep Pro access until that date.
...
Because Zaldo is a digital subscription service that you can evaluate for free (with both a free plan and a free trial before any charge), **payments are generally non-refundable**, and we do not provide prorated refunds for partial billing periods after a cancellation.

However, we want you to be treated fairly. We will consider refunds on a case-by-case basis, and will generally provide a refund in situations such as:
- You were charged after cancelling, due to a technical error.
- You were charged twice for the same period (duplicate charge).
- A clear billing error attributable to us.
...
If we change the price of a subscription, we will give you reasonable advance notice. Price changes apply to billing periods after the notice. If you do not agree to a new price, you may cancel before it takes effect.

---

## 6. Failed payments

If a recurring payment fails, we (via Stripe) may retry the charge. If payment continues to fail, your Pro access may be paused or your subscription cancelled, and your account will revert to the free plan. Your data is retained.
...
We're a small team and we read every message. If something went wrong with a charge, reach out — we'll make it right where we reasonably can.
